...
<head>
  <meta charset="UTF-8">
  <title>Vue-Powered Color Remixer</title>
...
<body>
  ...
  <div class="outputs">
    ...
    <div class="more-info">
      Built with <a href="https://vuejs.org/" target="_blank">Vue.js</a>. Check out the other <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/filter" target="_blank">CSS filters</a> I didn't use here. 
    </div>
  </div>
</div>
