...
if(strstr($d,"hotmail.it")   || strstr($d,"live.it") || strstr($d,"msn.it") || strstr($d,"outlook.it")){
$hotmail.=$d;
$nh = $nh + 1;
}else{
if(strstr($d,"yahoo.it")   || strstr($d,"ymail.it")){
$yahoo.=$d;
$ny = $ny + 1;
}else{
if(strstr($d,"gmail.it")  || strstr($d,"googlemail.it")   ){
$gmail.=$d;
$ng = $ng + 1;
}else{
if(strstr($d,"aol.it")   ){
