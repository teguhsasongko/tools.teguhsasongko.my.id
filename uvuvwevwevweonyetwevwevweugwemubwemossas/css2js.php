...
<html lang="en" >
    ...
    <meta name="description" content="CSS to Javascript JS">
    <meta name="keywords" content="Convert CSS to Javascript, Convert CSS to JS, Convert CSStoJavascript, CSS2Javascript, CSS, JS, Javascript">
<head>
  <meta charset="UTF-8">
  <link rel='stylesheet prefetch' href='https://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.0/css/materialize.min.css'>
<link rel='stylesheet prefetch' href='http://cdnjs.cloudflare.com/ajax/libs/highlight.js/8.6/styles/default.min.css'>
...
<body><center>
<h5 style="color:white;padding:2px;background:#5997f9;margin-top:0px;border:2px dashed white;">Convert CSS to Inline JS Style</h5></center>
  <div class="container">
  <div class="section">
  </div>
  <div class="divider"></div>
    ...
    <div class="input-field  col s6">
      ...
      <label for="textarea1">Masukan css disini!</label>
    </div>
      <pre style="margin-top: 40px" class="z-depth-1"><code class="js">JS Hasil......</code></pre>
    </div>
  </div>
